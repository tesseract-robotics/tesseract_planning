 ...
 */
#ifndef TESSERACT_MOTION_PLANNERS_IMPL_DESCARTES_DECARTES_LEGACY_MOTION_PLANNER_HPP
#define TESSERACT_MOTION_PLANNERS_IMPL_DESCARTES_DECARTES_LEGACY_MOTION_PLANNER_HPP
...
template <typename FloatType>
PlannerResponse DescartesLegacyMotionPlanner<FloatType>::solve(const PlannerRequest& request) const
{
...
template <typename FloatType>
bool DescartesLegacyMotionPlanner<FloatType>::checkUserInput(const PlannerRequest& request)
{
...
template <typename FloatType>
bool DescartesLegacyMotionPlanner<FloatType>::terminate()
{
...
template <typename FloatType>
void DescartesLegacyMotionPlanner<FloatType>::clear()
{
}

template <typename FloatType>
MotionPlanner::Ptr DescartesLegacyMotionPlanner<FloatType>::clone() const
{
  return std::make_shared<DescartesLegacyMotionPlanner<FloatType>>(name_);
}

template <typename FloatType>
std::shared_ptr<DescartesProblem<FloatType>>
DescartesLegacyMotionPlanner<FloatType>::createProblem(const PlannerRequest& request) const
{
...
#endif  // TESSERACT_MOTION_PLANNERS_IMPL_DESCARTES_DECARTES_LEGACY_MOTION_PLANNER_HPP

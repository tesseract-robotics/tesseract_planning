...
public:
  ...
  createCostAndConstraints(const MoveInstructionPoly& move_instruction,
...
public:
  ...
  virtual TrajOptTermInfos
  createCostAndConstraints(const tesseract_common::ManipulatorInfo& composite_manip_info,
                           const std::shared_ptr<const tesseract_environment::Environment>& env,

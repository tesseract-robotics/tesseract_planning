#ifndef TESSERACT_MOTION_PLANNERS_TRAJOPT_CEREAL_SERIALIZATIION_H
#define TESSERACT_MOTION_PLANNERS_TRAJOPT_CEREAL_SERIALIZATIION_H
...
#endif  // TESSERACT_MOTION_PLANNERS_TRAJOPT_CEREAL_SERIALIZATIION_H

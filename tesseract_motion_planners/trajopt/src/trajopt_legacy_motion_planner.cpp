...
{
TrajOptLegacyMotionPlanner::TrajOptLegacyMotionPlanner(std::string name) : name_(std::move(name))
{
  if (name_.empty())
    throw std::runtime_error("TrajOptMotionPlanner name is empty!");
}

const std::string& TrajOptLegacyMotionPlanner::getName() const { return name_; }

bool TrajOptLegacyMotionPlanner::terminate()
{
  CONSOLE_BRIDGE_logWarn("Termination of ongoing optimization is not implemented yet");
  return false;
}

void TrajOptLegacyMotionPlanner::clear() {}

MotionPlanner::Ptr TrajOptLegacyMotionPlanner::clone() const
{
  return std::make_shared<TrajOptLegacyMotionPlanner>(name_);
}

PlannerResponse TrajOptLegacyMotionPlanner::solve(const PlannerRequest& request) const
{
...
bool TrajOptLegacyMotionPlanner::checkUserInput(const PlannerRequest& request)
{
...
TrajOptLegacyMotionPlanner::createProblem(const PlannerRequest& request) const
{
  // Store fixed steps

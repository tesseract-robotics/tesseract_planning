...
void TrajOptIfoptLegacyMotionPlanner::clear() { callbacks.clear(); }

MotionPlanner::Ptr TrajOptIfoptLegacyMotionPlanner::clone() const
{
  return std::make_shared<TrajOptIfoptLegacyMotionPlanner>(name_);
}

PlannerResponse TrajOptIfoptLegacyMotionPlanner::solve(const PlannerRequest& request) const
{
...
bool TrajOptIfoptLegacyMotionPlanner::checkUserInput(const PlannerRequest& request)
{
...
std::shared_ptr<TrajOptIfoptProblem> TrajOptIfoptLegacyMotionPlanner::createProblem(const PlannerRequest& request) const
{
  // Store fixed steps

...
public:
  ...
  SimplePlannerLVSMoveProfile(const YAML::Node& config, const tesseract::common::ProfilePluginFactory& plugin_factory);
  ...
  bool operator==(const SimplePlannerLVSMoveProfile& rhs) const;
  bool operator!=(const SimplePlannerLVSMoveProfile& rhs) const;
};

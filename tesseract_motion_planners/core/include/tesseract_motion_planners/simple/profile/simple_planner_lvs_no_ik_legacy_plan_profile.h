...
#ifndef TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_NO_IK_LEGACY_PLAN_PROFILE_H
#define TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_NO_IK_LEGACY_PLAN_PROFILE_H
...
public:
  ...
  using ConstPtr = std::shared_ptr<const SimplePlannerLVSNoIKLegacyPlanProfile>;
   ...
   */
  SimplePlannerLVSNoIKLegacyPlanProfile(double state_longest_valid_segment_length = 5 * M_PI / 180,
...
#endif  // TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_NO_IK_LEGACY_PLAN_PROFILE_H

...
#ifndef TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_ASSIGN_LEGACY_PLAN_PROFILE_H
#define TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_ASSIGN_LEGACY_PLAN_PROFILE_H
...
{
class SimplePlannerFixedSizeAssignLegacyPlanProfile : public SimplePlannerLegacyPlanProfile
{
public:
  using Ptr = std::shared_ptr<SimplePlannerFixedSizeAssignLegacyPlanProfile>;
  using ConstPtr = std::shared_ptr<const SimplePlannerFixedSizeAssignLegacyPlanProfile>;
   ...
   */
  SimplePlannerFixedSizeAssignLegacyPlanProfile(int freespace_steps = 10, int linear_steps = 10);
...
#endif  // TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_ASSIGN_LEGACY_PLAN_PROFILE_H

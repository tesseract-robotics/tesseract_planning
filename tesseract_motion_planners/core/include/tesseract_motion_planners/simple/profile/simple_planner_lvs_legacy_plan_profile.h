...
#ifndef TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_LEGACY_PLAN_PROFILE_H
#define TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_LEGACY_PLAN_PROFILE_H
...
class SimplePlannerLVSLegacyPlanProfile : public SimplePlannerLegacyPlanProfile
{
public:
  using Ptr = std::shared_ptr<SimplePlannerLVSLegacyPlanProfile>;
  using ConstPtr = std::shared_ptr<const SimplePlannerLVSLegacyPlanProfile>;
   ...
   */
  SimplePlannerLVSLegacyPlanProfile(double state_longest_valid_segment_length = 5 * M_PI / 180,
...
#endif  // TESSERACT_MOTION_PLANNERS_SIMPLE_LVS_LEGACY_PLAN_PROFILE_H

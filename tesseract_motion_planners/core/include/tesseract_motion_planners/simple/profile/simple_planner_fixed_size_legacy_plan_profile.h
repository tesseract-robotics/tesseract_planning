 ...
 */
#ifndef TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_LEGACY_PLAN_PROFILE_H
#define TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_LEGACY_PLAN_PROFILE_H
...
class SimplePlannerFixedSizeLegacyPlanProfile : public SimplePlannerPlanProfile
{
public:
  using Ptr = std::shared_ptr<SimplePlannerFixedSizeLegacyPlanProfile>;
  using ConstPtr = std::shared_ptr<const SimplePlannerFixedSizeLegacyPlanProfile>;
   ...
   */
  SimplePlannerFixedSizeLegacyPlanProfile(int freespace_steps = 10, int linear_steps = 10);
...
#endif  // TESSERACT_MOTION_PLANNERS_SIMPLE_FIXED_SIZE_LEGACY_PLAN_PROFILE_H

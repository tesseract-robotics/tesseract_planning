...
#include <tesseract/motion_planners/trajopt/profile/trajopt_default_solver_profile.h>
...
int main(int /*argc*/, char** /*argv*/)
{
  try
  {
    ...
    profiles->addProfile(DESCARTES_DEFAULT_NAMESPACE, DEFAULT_PROFILE_KEY, descartes_move_profile);

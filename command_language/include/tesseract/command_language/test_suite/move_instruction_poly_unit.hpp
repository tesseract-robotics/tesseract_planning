...
#include <tesseract/command_language/test_suite/instruction_poly_unit.hpp>
...
void runMoveInstructionSettersTest()
{
  ...
  tesseract::common::ManipulatorInfo manip_info(
      "manip", tesseract::common::LinkId::fromName("base_link"), tesseract::common::LinkId::fromName("tool0"));
  ...
  tesseract::common::ManipulatorInfo manip_info2(
      "manip2", tesseract::common::LinkId::fromName("base_link2"), tesseract::common::LinkId::fromName("tool02"));

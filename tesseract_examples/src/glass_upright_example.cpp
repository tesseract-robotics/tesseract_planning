...
bool GlassUprightExample::run()
{
  ...
  if (ifopt_)
  {
    ...
    profiles->addProfile<TrajOptIfoptCompositeProfile>(
        TRAJOPT_IFOPT_DEFAULT_NAMESPACE, DEFAULT_PROFILE_KEY, composite_profile);
    ...
    profiles->addProfile<TrajOptIfoptPlanProfile>(
        TRAJOPT_IFOPT_DEFAULT_NAMESPACE, DEFAULT_PROFILE_KEY, plan_profile);
  }
  else
  {
    ...
    profiles->addProfile<TrajOptCompositeProfile>(
        TRAJOPT_DEFAULT_NAMESPACE, DEFAULT_PROFILE_KEY, composite_profile);
    ...
    profiles->addProfile<TrajOptPlanProfile>(TRAJOPT_DEFAULT_NAMESPACE, DEFAULT_PROFILE_KEY, plan_profile);
  }

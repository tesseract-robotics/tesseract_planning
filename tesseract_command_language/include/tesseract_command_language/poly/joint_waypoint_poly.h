...
private:
  template <class Archive>
  friend void ::tesseract::command_language::serialize(Archive& ar, JointWaypointInterface& obj);
};
...
private:
  ...
  template <class Archive>
  friend void ::tesseract::command_language::serialize(Archive& ar, JointWaypointPoly& obj);
};

...
bool BasicCartesianExample::run()
{
  ...
  // Create Program
  CompositeInstruction program("cartesian_program", ManipulatorInfo("manipulator", tesseract::common::LinkId::fromName("base_link"), tesseract::common::LinkId::fromName("tool0")));

...
{
GlassUprightExample::GlassUprightExample(std::shared_ptr<tesseract::environment::Environment> env,
...
inline tesseract::environment::Command::Ptr addSphere()
{
...
bool GlassUprightExample::run()
{
  ...
  // Create Program
  CompositeInstruction program("UPRIGHT", ManipulatorInfo("manipulator", tesseract::common::LinkId::fromName("base_link"), tesseract::common::LinkId::fromName("tool0")));

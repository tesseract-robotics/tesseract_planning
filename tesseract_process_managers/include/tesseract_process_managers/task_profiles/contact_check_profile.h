 ...
 */
#ifndef TESSERACT_PROCESS_MANAGERS_CONTACT_CHECK_PROFILE_H
#define TESSERACT_PROCESS_MANAGERS_CONTACT_CHECK_PROFILE_H
...
struct ContactCheckProfile
{
  ...
  ContactCheckProfile(double longest_valid_segment_length, double contact_distance)
  {
    ...
    config.collision_margin_override_type = tesseract_collision::CollisionMarginOverrideType::OVERRIDE_DEFAULT_MARGIN;
...
#endif  // TESSERACT_PROCESS_MANAGERS_CONTACT_CHECK_PROFILE_H

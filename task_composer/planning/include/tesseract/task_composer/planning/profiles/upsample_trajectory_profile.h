...
{
struct TESSERACT_TASK_COMPOSER_PLANNING_NODES_EXPORT UpsampleTrajectoryProfile : public tesseract::common::Profile
{
  ...
  UpsampleTrajectoryProfile(const YAML::Node& config, const tesseract::common::ProfilePluginFactory& plugin_factory);

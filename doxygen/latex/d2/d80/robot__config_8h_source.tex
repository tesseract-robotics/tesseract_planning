...
\DoxyCodeLine{74 \textcolor{keyword}{inline} \mbox{\hyperlink{namespacetesseract__planning_adc15a5456ea446dfa3dc95852bc9d579}{RobotConfig}} \mbox{\hyperlink{namespacetesseract__planning_afb2005ce4bffdfb711e9db3cd91768e9}{getRobotConfig}}(\textcolor{keyword}{const} tesseract\_kinematics::JointGroup\& \mbox{\hyperlink{ompl__planner__tests_8cpp_a553a400a0c81f57e4dd2d27aefef9b9c}{joint\_group}},}
\DoxyCodeLine{75                                   \textcolor{keyword}{const} std::string\& base\_link,}
\DoxyCodeLine{76                                   \textcolor{keyword}{const} std::string\& \mbox{\hyperlink{ompl__planner__tests_8cpp_a5f746d461721e8676a6f317d3884e327}{tcp\_frame}},}
\DoxyCodeLine{77                                   \textcolor{keyword}{const} Eigen::Ref<\textcolor{keyword}{const} Eigen::Matrix<FloatType, Eigen::Dynamic, 1>>\& \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}},}
...
\DoxyCodeLine{99   \textcolor{keywordflow}{if} ((sign\_correction[1] * \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(4)) >= 0)}
...
\DoxyCodeLine{105   \textcolor{keywordflow}{if} ((sign\_correction[0] * \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(2)) < M\_PI / 2)}
...
\DoxyCodeLine{146 \textcolor{keyword}{inline} Eigen::VectorXi \mbox{\hyperlink{namespacetesseract__planning_a8c543584d607b7345d6ad3e12178f48c}{getJointTurns}}(\textcolor{keyword}{const} Eigen::Ref<\textcolor{keyword}{const} Eigen::Matrix<FloatType, Eigen::Dynamic, 1>>\& \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}})}
\DoxyCodeLine{147 \{}
\DoxyCodeLine{148   Eigen::VectorXi joint\_turns;}
\DoxyCodeLine{149   joint\_turns.resize(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.rows());}
\DoxyCodeLine{150   \textcolor{keywordflow}{for} (Eigen::Index i = 0; i < \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.rows(); ++i)}
\DoxyCodeLine{151     joint\_turns(i) = int(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(i) / M\_PI);}
\DoxyCodeLine{152 }

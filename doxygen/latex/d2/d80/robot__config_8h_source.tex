...
\DoxyCodeLine{157 }
\DoxyCodeLine{158 \textcolor{preprocessor}{\#ifdef SWIG}}
\DoxyCodeLine{159 \%\textcolor{keyword}{template}(\mbox{\hyperlink{namespacetesseract__planning_afb2005ce4bffdfb711e9db3cd91768e9}{getRobotConfig}}) tesseract\_planning::getRobotConfig<double>;}
\DoxyCodeLine{160 \%\textcolor{keyword}{template}(\mbox{\hyperlink{namespacetesseract__planning_a8c543584d607b7345d6ad3e12178f48c}{getJointTurns}}) tesseract\_planning::getJointTurns<double>;}
\DoxyCodeLine{161 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// SWIG}}
\DoxyCodeLine{162 }
\DoxyCodeLine{163 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// TESSERACT\_COMMAND\_LANGUAGE\_ROBOT\_CONFIG\_H}}

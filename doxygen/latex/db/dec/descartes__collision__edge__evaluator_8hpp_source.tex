...
\DoxyCodeLine{43     tesseract\_kinematics::JointGroup::ConstPtr manip,}
...
\DoxyCodeLine{47   : manip\_(std::move(manip))}
...
\DoxyCodeLine{64 \mbox{\hyperlink{classtesseract__planning_1_1DescartesCollisionEdgeEvaluator_a30427575131a80dda8ef9b9160194149}{DescartesCollisionEdgeEvaluator<FloatType>::evaluate}}(\textcolor{keyword}{const} descartes\_light::State<FloatType>\& start,}
...
\DoxyCodeLine{67   assert(start.values.rows() == end.values.rows());}
\DoxyCodeLine{68 }
...
\DoxyCodeLine{71   tesseract\_common::TrajArray segment(2, start.values.rows());}
\DoxyCodeLine{72   \textcolor{keywordflow}{for} (Eigen::Index i = 0; i < start.values.rows(); ++i)}
\DoxyCodeLine{73   \{}
\DoxyCodeLine{74     segment(0, i) = start[i];}
...
\DoxyCodeLine{116   \textcolor{keyword}{auto} it = continuous\_contact\_managers\_.find(hash);}
\DoxyCodeLine{117   \textcolor{keywordflow}{if} (it == continuous\_contact\_managers\_.end())}
\DoxyCodeLine{118   \{}
...
\DoxyCodeLine{149   \textcolor{keyword}{auto} it = discrete\_contact\_managers\_.find(hash);}
\DoxyCodeLine{150   \textcolor{keywordflow}{if} (it == discrete\_contact\_managers\_.end())}
\DoxyCodeLine{151   \{}

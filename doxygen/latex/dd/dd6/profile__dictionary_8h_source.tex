...
\DoxyCodeLine{75     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{76     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
\DoxyCodeLine{77       \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{78 }
\DoxyCodeLine{79     \textcolor{keywordflow}{return} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.find(std::type\_index(\textcolor{keyword}{typeid}(ProfileType))) != \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.end());}
\DoxyCodeLine{80   \}}
\DoxyCodeLine{81 }
...
\DoxyCodeLine{87 }
\DoxyCodeLine{88     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{89     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
\DoxyCodeLine{90       \textcolor{keywordflow}{return};}
\DoxyCodeLine{91 }
\DoxyCodeLine{92     \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.erase(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{93   \}}
\DoxyCodeLine{94 }
...
\DoxyCodeLine{103     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{104     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
...
\DoxyCodeLine{106 }
\DoxyCodeLine{107     \textcolor{keyword}{auto} it2 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.find(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{108     \textcolor{keywordflow}{if} (it2 != \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.end())}
...
\DoxyCodeLine{123   \textcolor{keywordtype}{void} \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_a3d2b329c3e514c1f50400abaa2b38419}{addProfile}}(\textcolor{keyword}{const} std::string\& ns, \textcolor{keyword}{const} std::string\& profile\_name, std::shared\_ptr<const ProfileType> \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}})}
\DoxyCodeLine{124   \{}
...
\DoxyCodeLine{130 }
\DoxyCodeLine{131     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}} == \textcolor{keyword}{nullptr})}
...
\DoxyCodeLine{135     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{136     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
\DoxyCodeLine{137     \{}
\DoxyCodeLine{138       std::unordered\_map<std::string, std::shared\_ptr<const ProfileType>> new\_entry;}
\DoxyCodeLine{139       new\_entry[profile\_name] = \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}};}
...
\DoxyCodeLine{143     \{}
\DoxyCodeLine{144       \textcolor{keyword}{auto} it2 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.find(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{145       \textcolor{keywordflow}{if} (it2 != \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.end())}
\DoxyCodeLine{146       \{}
\DoxyCodeLine{147         std::any\_cast<std::unordered\_map<std::string, std::shared\_ptr<const ProfileType>>\&>(it2-\/>second)[profile\_name] =}
\DoxyCodeLine{148             \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}};}
\DoxyCodeLine{149       \}}
...
\DoxyCodeLine{153         new\_entry[profile\_name] = \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}};}
\DoxyCodeLine{154         \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second[std::type\_index(\textcolor{keyword}{typeid}(ProfileType))] = new\_entry;}
\DoxyCodeLine{155       \}}
\DoxyCodeLine{156     \}}
\DoxyCodeLine{157   \}}
\DoxyCodeLine{158 }
...
\DoxyCodeLine{168     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{169     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
\DoxyCodeLine{170       \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{171 }
\DoxyCodeLine{172     \textcolor{keyword}{auto} it2 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.find(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{173     \textcolor{keywordflow}{if} (it2 != \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.end())}
\DoxyCodeLine{174     \{}
\DoxyCodeLine{175       \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_ad7d948648dd0c092c64fdb8fa60ee97f}{profile\_map}} =}
\DoxyCodeLine{176           std::any\_cast<const std::unordered\_map<std::string, std::shared\_ptr<const ProfileType>>\&>(it2-\/>second);}
\DoxyCodeLine{177       \textcolor{keyword}{auto} it3 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_ad7d948648dd0c092c64fdb8fa60ee97f}{profile\_map}}.find(profile\_name);}
\DoxyCodeLine{178       \textcolor{keywordflow}{if} (it3 != \mbox{\hyperlink{profile__dictionary__tests_8cpp_ad7d948648dd0c092c64fdb8fa60ee97f}{profile\_map}}.end())}
...
\DoxyCodeLine{194     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.at(ns);}
\DoxyCodeLine{195     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& it2 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}.at(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{196     \textcolor{keyword}{const} \textcolor{keyword}{auto}\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_ad7d948648dd0c092c64fdb8fa60ee97f}{profile\_map}} =}
\DoxyCodeLine{197         std::any\_cast<const std::unordered\_map<std::string, std::shared\_ptr<const ProfileType>>\&>(it2);}
\DoxyCodeLine{198     \textcolor{keywordflow}{return} \mbox{\hyperlink{profile__dictionary__tests_8cpp_ad7d948648dd0c092c64fdb8fa60ee97f}{profile\_map}}.at(profile\_name);}
\DoxyCodeLine{199   \}}
\DoxyCodeLine{200 }
...
\DoxyCodeLine{209     \textcolor{keyword}{auto} \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} = \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.find(ns);}
\DoxyCodeLine{210     \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}} == \mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aff842a30b67daa75fcafe9c3921db6b9}{profiles\_}}.end())}
\DoxyCodeLine{211       \textcolor{keywordflow}{return};}
\DoxyCodeLine{212 }
\DoxyCodeLine{213     \textcolor{keyword}{auto} it2 = \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.find(std::type\_index(\textcolor{keyword}{typeid}(ProfileType)));}
\DoxyCodeLine{214     \textcolor{keywordflow}{if} (it2 != \mbox{\hyperlink{profile__dictionary__tests_8cpp_a325f3c2b297a245575c6f2f91bd5f1e2}{it}}-\/>second.end())}

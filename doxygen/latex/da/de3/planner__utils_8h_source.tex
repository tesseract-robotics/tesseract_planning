...
\DoxyCodeLine{54 \textcolor{keywordtype}{bool} \mbox{\hyperlink{namespacetesseract__planning_af0a6a646d66932568a74534b67fb709b}{isWithinJointLimits}}(\textcolor{keyword}{const} Eigen::Ref<\textcolor{keyword}{const} Eigen::Matrix<FloatType, Eigen::Dynamic, 1>>\& \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}},}
...
\DoxyCodeLine{57 \{}
\DoxyCodeLine{58   \textcolor{keywordflow}{if} (tesseract\_common::isWithinPositionLimits<FloatType>(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}, limits))}
\DoxyCodeLine{59   \{}
\DoxyCodeLine{60     \textcolor{keywordflow}{if} (((\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.size() -\/ 3) + \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.size() -\/ 1)) < coupling\_limits(0)) ||}
\DoxyCodeLine{61         ((\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.size() -\/ 3) + \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.size() -\/ 1)) > coupling\_limits(1)))}
...
\DoxyCodeLine{81                   \textcolor{keyword}{const} Eigen::Ref<\textcolor{keyword}{const} Eigen::Matrix<FloatType, Eigen::Dynamic, 1>>\& \mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}},}
\DoxyCodeLine{82                   \textcolor{keyword}{const} Eigen::Matrix<FloatType, Eigen::Dynamic, 2>\& limits)}
\DoxyCodeLine{83 \{}
\DoxyCodeLine{84   \textcolor{keywordflow}{if} (!tesseract\_common::isWithinPositionLimits(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}, limits))}
...
\DoxyCodeLine{90       getRobotConfig<FloatType>(\mbox{\hyperlink{joint__waypoint__unit_8cpp_a92a1dd25d82ead2eaba8f5ae7e4ba88b}{joint\_values}}.tail(robot\_kin-\/>numJoints()), robot\_kin, sign\_correction);}
\DoxyCodeLine{91 }
...
\DoxyCodeLine{104                                     \textcolor{keyword}{const} std::string\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}},}
...
\DoxyCodeLine{107 \{}
\DoxyCodeLine{108   std::string results = \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}};}
\DoxyCodeLine{109   \textcolor{keywordflow}{if} (\mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}}.empty())}
\DoxyCodeLine{110     results = std::move(default\_profile);}
\DoxyCodeLine{111 }
\DoxyCodeLine{112   \textcolor{comment}{// Check for remapping of profile}}
\DoxyCodeLine{113   \textcolor{keyword}{auto} \mbox{\hyperlink{tesseract__motion__planners_2test_2utils__test_8cpp_a51171346a6f0e28f848f60cad4d96b9c}{remap}} = profile\_remapping.find(ns);}
\DoxyCodeLine{114   \textcolor{keywordflow}{if} (\mbox{\hyperlink{tesseract__motion__planners_2test_2utils__test_8cpp_a51171346a6f0e28f848f60cad4d96b9c}{remap}} != profile\_remapping.end())}
\DoxyCodeLine{115   \{}
\DoxyCodeLine{116     \textcolor{keyword}{auto} p = \mbox{\hyperlink{tesseract__motion__planners_2test_2utils__test_8cpp_a51171346a6f0e28f848f60cad4d96b9c}{remap}}-\/>second.find(\mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}});}
\DoxyCodeLine{117     \textcolor{keywordflow}{if} (p != \mbox{\hyperlink{tesseract__motion__planners_2test_2utils__test_8cpp_a51171346a6f0e28f848f60cad4d96b9c}{remap}}-\/>second.end())}
...
\DoxyCodeLine{133                                               \textcolor{keyword}{const} std::string\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}},}
...
\DoxyCodeLine{136 \{}
\DoxyCodeLine{137   \textcolor{keywordflow}{if} (profile\_dictionary.\mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_aa72e7841d99a279c706c6cac7e73b2a2}{hasProfile}}<ProfileType>(ns, \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}}))}
\DoxyCodeLine{138     \textcolor{keywordflow}{return} profile\_dictionary.\mbox{\hyperlink{classtesseract__planning_1_1ProfileDictionary_a76d882f0e611b3404718188d5da22a2c}{getProfile}}<ProfileType>(ns, \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}});}
\DoxyCodeLine{139 }
...
\DoxyCodeLine{143                           \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}}.c\_str(),}
...
\DoxyCodeLine{169                                                          \textcolor{keyword}{const} std::string\& \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}},}
...
\DoxyCodeLine{175 }
\DoxyCodeLine{176   \textcolor{keywordflow}{if} (overrides-\/>hasProfile<ProfileType>(ns, \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}}))}
\DoxyCodeLine{177     \textcolor{keywordflow}{return} overrides-\/>getProfile<ProfileType>(ns, \mbox{\hyperlink{profile__dictionary__tests_8cpp_abef2081b208ab62011ea9a1557a0be70}{profile}});}
\DoxyCodeLine{178 }

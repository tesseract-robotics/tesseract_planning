 ...
 */
#ifndef TESSERACT_TASK_COMPOSER_INTERATIVE_SPLINE_PARAMETERIZATION_PROFILE_H
#define TESSERACT_TASK_COMPOSER_INTERATIVE_SPLINE_PARAMETERIZATION_PROFILE_H
...
#endif  // TESSERACT_TASK_COMPOSER_INTERATIVE_SPLINE_PARAMETERIZATION_PROFILE_H

 ...
 * @brief The default namespaces for each of the task
 *
 ...
 */
#ifndef TESSERACT_TASK_COMPOSER_DEFAULT_TASK_NAMESPACES_H
#define TESSERACT_TASK_COMPOSER_DEFAULT_TASK_NAMESPACES_H
...
{
// clang-format off
static const std::string CHECK_INPUT_DEFAULT_NAMESPACE                       = "CHECK_INPUT";
...
static const std::string MIN_LENGTH_DEFAULT_NAMESPACE                   = "SEED_MIN_LENGTH_CHECK";
...
#endif  // TESSERACT_TASK_COMPOSER_DEFAULT_TASK_NAMESPACES_H

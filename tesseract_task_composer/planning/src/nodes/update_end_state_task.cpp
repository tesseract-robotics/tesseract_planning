...
TaskComposerNodeInfo::UPtr UpdateEndStateTask::runImpl(const TaskComposerContext::Ptr& context,
                                                       OptionalTaskComposerExecutor /*executor*/) const
{
  ...
  auto input_next_data_poly = context->getDataStorage().getData(input_keys_[1]);

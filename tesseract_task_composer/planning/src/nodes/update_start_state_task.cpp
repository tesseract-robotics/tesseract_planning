                                                                    ...
                                                                    OptionalTaskComposerExecutor /*executor*/) const
{
  ...
  {
    info->status_message =
        "UpdateStartStateTask: Input data for key '" + input_keys_[0] + "' must be a composite instruction";
  ...
  {
    info->status_message =
        "UpdateStartStateTask: Input data for key '" + input_keys_[1] + "' must be a composite instruction";
    CONSOLE_BRIDGE_logError("%s", info->status_message.c_str());
    return info;
  }

#ifndef TESSERACT_TASK_COMPOSER_FREESPACE_EXAMPLE_PROGRAM_H
#define TESSERACT_TASK_COMPOSER_FREESPACE_EXAMPLE_PROGRAM_H
...
#endif  // TESSERACT_TASK_COMPOSER_FREESPACE_EXAMPLE_PROGRAM_H

...
PlanningTaskComposerProblem::PlanningTaskComposerProblem(TaskComposerDataStorage input_data, std::string name)
...
PlanningTaskComposerProblem::PlanningTaskComposerProblem(tesseract_environment::Environment::ConstPtr env,
                                                         ...
                                                         std::string name)
  : TaskComposerProblem(std::move(input_data), std::move(name)), env(std::move(env)), manip_info(std::move(manip_info))
{
}
...
PlanningTaskComposerProblem::PlanningTaskComposerProblem(tesseract_environment::Environment::ConstPtr env,
                                                         TaskComposerDataStorage input_data,
                                                         std::string name)
  : TaskComposerProblem(std::move(input_data), std::move(name)), env(std::move(env))
{
}

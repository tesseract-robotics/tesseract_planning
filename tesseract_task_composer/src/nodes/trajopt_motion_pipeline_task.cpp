...
{
TrajOptMotionPipelineTask::TrajOptMotionPipelineTask(std::string name) : TaskComposerGraph(std::move(name))
{
...
bool TrajOptMotionPipelineTask::operator!=(const TrajOptMotionPipelineTask& rhs) const { return !operator==(rhs); }
